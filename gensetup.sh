...
py2applet --make-setup FlukeController.py --includes appscript,mutagen --plist ./resources/Info.plist --iconfile ./resources/Fluke.icns --resources ./resources/Fluke-Flac.icns 
echo ==============
